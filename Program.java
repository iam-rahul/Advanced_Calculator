...
public Program() {
	...
	this.setTitle("Advanced_Calculator - Rahul Raina (Dr. Umesh Tiwari)");
				...
				menuItems[0].addActionListener(new ActionListener() {
					public void actionPerformed(ActionEvent e) {
						...
						JOptionPane.showMessageDialog(null,
							"Advanced_Calculator  \u2017  A GEU MCA - 4th Java Project\n" +
							"Copyright \u00a9 2017 Dr. Umesh Tiwari. All Rights Reserved.",
								"About Advanced_Calculator...", JOptionPane.INFORMATION_MESSAGE);
					}
				});
				break;
		}
